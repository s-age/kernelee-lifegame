...
// destination — this decision is LoopState.phase). This gate, however, is an
...
//
// Passed as a bare identifier to `pipeline(meta, runningPhaseGate)` (as a named
...
/**
 * Phase gate (abort unless running = natural stop, settling the phase on idle).
 */
export function runningPhaseGate(kernel: Kernel, _payload: void) {
